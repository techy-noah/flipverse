...
export default function DeckDetailPage() {
  ...
  const handleStart = () => {
    const mode = shuffle ? 'shuffle' : 'all';
    router.push(`/quiz?deck=${deckId}&mode=${mode}`);
  };
        ...
        <div className="bg-surface rounded-xl border border-border p-4">
            ...
            <div className="bg-surface rounded-xl border border-border p-4">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-text">Start Quiz</h3>
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150 active:scale-95 ${
                    shuffle
                      ...
                      : 'bg-surface-elevated text-text-secondary hover:text-text'
                  }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M2 18h1.4c1.3 0 2.5-.7 3.1-1.8l9.1-12.4c.6-1.1 1.8-1.8 3.1-1.8H22" />
                    <path d="m18 2 4 4-4 4" />
                    <path d="M2 6h1.4c1.3 0 2.5.7 3.1 1.8l9.1 12.4c.6 1.1 1.8 1.8 3.1 1.8H22" />
